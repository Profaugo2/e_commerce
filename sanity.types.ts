...
export type Product = {
  ...
  status?: "new" | "hot" | "sale";
  variant?: "gadget" | "smart" | "appliances" | "others";
  isFeatured?: boolean;
};
...
export type AllSanitySchemaTypes = Order | Product | Brand | Blog | Blockcategory | Address | Post | Author | Category | BlockContent | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
export type QueryResult = Array<{
  ...
  products: Array<{
    product: {
      ...
      status?: "hot" | "new" | "sale";
      variant?: "appliances" | "gadget" | "others" | "smart";
      isFeatured?: boolean;
    } | null;
    quantity?: number;
    _key: string;
...
// Source: ./sanity/queries/query.tsx
