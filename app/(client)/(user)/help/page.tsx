        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <div className="text-lg font-bold">+237-652-137-899</div>
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <div className="text-lg font-bold">nedyshop88@gmail.com</div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Clock className="h-4 w-4" />
              ...
              <CardContent>
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="item-3">
                    ...
                    <AccordionContent>
                      Standard shipping typically takes 2-4 business days depending on your Location in cameroon. 
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-5">
                    ...
                    <AccordionContent>
                      Yes, we ship in case the customer is abraod. You can see the shipping options available to
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <div className="font-medium">Douala - Camerron</div>
          ...
          <CardContent>
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="flex flex-col items-center justify-center p-4 text-center border rounded-lg">
                ...
                <Button className="mt-4">+237-652-137-899</Button>
              </div>
              <div className="flex flex-col items-center justify-center p-4 text-center border rounded-lg">
