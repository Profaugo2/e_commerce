...
const SearchBar = () => {
  ...
  return (
    <Dialog open={showSearch} onOpenChange={() => setShowSearch(!showSearch)}>
      ...
      <DialogContent className="w-full max-w-4xl sm:max-w-5xl md:max-w-6xl min-h-[90vh] max-h-[90vh] flex flex-col overflow-hidden bg-white">
        <DialogHeader>
              ...
              <div className="text-center py-10 font-semibold tracking-wide">
                {search && products?.length ? (
                  ...
                  <p className="text-green-600 flex items-center justify-center gap-1">
                    <Search className="w-5 h-5" />
                    Search and explore your products from Nedy Shop Store.
                  </p>
                )}
              </div>
            )}
